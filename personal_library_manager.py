...
option = st.sidebar.selectbox("Select an option", ["🏠 Home", "➕ Add Book", "🔍 Search Book", "✔️ Mark as Read", "❌ Delete Book"])
...
st.sidebar.write("📌 Built with ❤ by [Qasim](https://github.com/Qasim3211)")